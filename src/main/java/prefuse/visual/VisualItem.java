...
/**
 * <p>
 * Base interface for representing a visual item, a data object with a visual
 * interactive form. VisualItems are Tuple instances, and so can support any
 * number of data fields in a backing data table. VisualItems also support data
 * fields specific to visualization, such as a location, bounding box, colors,
 * size, and font. The VisualItem interface provides convenience methods for
 * accessing these common visual properties, but the underlying mechanism is the
 * same as any Tuple -- data stored in a tabular format. Just as all Tuple
 * instances are backed by a data Table, each VisualItem is backed by a
 * VisualTable. Additionally, each VisualItem is associated with one and only
 * one {@link prefuse.Visualization}.
 * </p>
 *
 * <p>
 * VisualItems are only responsible for storing their visual data properties.
 * The final visual appearance of an item is determined by a
 * {@link prefuse.render.Renderer}, which contains instructions for drawing the
 * item. The Renderer to use for a given item is decided by the
 * {@link prefuse.render.RendererFactory} associated with the item's backing
 * Visualization.
 * </p>
 *
 * <p>
 * Finally, actually setting the visual properties of VisualItems is commonly
 * done by the many {@link prefuse.action.Action} modules available for
 * processing visual data. This includes spatial layout as well as color, size,
 * and font assignment.
 * </p>
 *
...
public interface VisualItem extends Tuple {
    ...
    /**
     * Get the primary data group of which this VisualItem is a member. Returns
     * the name of the group of this item's backing VisualTable.
     *
     ...
     *
     * @return the backing data set from which this VisualItem is derived, or
     *         null if none.
     */
     ...
     * returns null if this VisualItem is not derived from backing data.
     *
     * @return the backing data tuple from which this VisualItem is derived, or
     *         null if none.
     */
    ...
    /**
     * Render this item to the given graphics context. This is typically done by
     * requesting the appropriate Renderer from the backing Visualization's
    ...
    /**
     * Indicates this item is expanded. Only used for items that are part of a
     * graph structure.
     *
    ...
    /**
     * Indicates if the item is fixed, and so will not have its position changed
     * by any layout or distortion actions.
     *
    ...
    /**
     * Get the bounding box for this VisualItem. If necessary, the bounds will
     * be validated before returning the bounding box.
     *
     ...
     * modules when the bounds are validated, or set by processing Actions used
     * in conjunction with Renderers that do not perform bounds management.
     *
     * @param x
    ...
    /**
     * Get the current fill color of this item. The fill color is used to fill
    ...
    /**
     * Set the current fill color of this item. The fill color is used to fill
     * the interior of shapes. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with a zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Get the starting fill color of this item. The fill color is used to fill
     * the interior of shapes. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
    ...
    /**
     * Set the starting fill color of this item. The fill color is used to fill
     * the interior of shapes. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with a zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Get the ending fill color of this item. The fill color is used to fill
     * the interior of shapes. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Set the ending fill color of this item. The fill color is used to fill
     * the interior of shapes. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with a zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Get the current text color of this item. The text color is used to draw
    ...
    /**
     * Set the current text color of this item. The text color is used to draw
     * text strings for the item. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with a zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Get the starting text color of this item. The text color is used to draw
     * text strings for the item. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Set the starting text color of this item. The text color is used to draw
     * text strings for the item. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with a zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Get the ending text color of this item. The text color is used to draw
     * text strings for the item. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Set the ending text color of this item. The text color is used to draw
     * text strings for the item. Color values as represented as an integer
     * containing the red, green, blue, and alpha (transparency) color channels.
     * A color with a zero alpha component is fully transparent and will not be
     * drawn.
    ...
    /**
     * Get the current size value of the item. Size values are typically used to
    ...
    /**
     * Set the current size value of the item. Size values are typically used to
     * scale an item, either in one-dimension (e.g., a bar chart length) or
     * two-dimensions (e.g., using pixel area to encode a quantitative value).
     *
     * @param size
    ...
    /**
     * Get the ending size value of the item. Size values are typically used to
     * scale an item, either in one-dimension (e.g., a bar chart length) or
     * two-dimensions (e.g., using pixel area to encode a quantitative value).
     *
    ...
    /**
     * Set the ending size value of the item. Size values are typically used to
     * scale an item, either in one-dimension (e.g., a bar chart length) or
     * two-dimensions (e.g., using pixel area to encode a quantitative value).
     *
     * @param size
     ...
     */
    public void setStroke(Shape stroke);
    ...
    /**
     * The start polygon data field. Not included in the VisualItem schema by
     * default
     */
    public static final String STARTPOLYGON = PrefuseLib.getStartField(VisualItem.POLYGON);
    /**
     * The end polygon data field. Not included in the VisualItem schema by
     * default
     */
    public static final String ENDPOLYGON = PrefuseLib.getEndField(VisualItem.POLYGON);
    ...
    /**
     * As JDK does not provide directly a value to simulate an empty bounds, we
     * will re-create it using a BoundingBox with a maxX < minX, so method
     * {@link Bounds#isEmpty()} will return true.
     */
    public static final Bounds EMPTY_BOUNDS = new BoundingBox(0, 0, -1, -1);
