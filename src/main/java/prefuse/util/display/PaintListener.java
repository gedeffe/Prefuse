...
/**
 * Listener interface for monitoring paint events on a Display. This listener is
 * notified both directly before and after a Display has been painted, and
 * allows for custom painting to be performed.
 *
