...
public class EdgeRenderer extends AbstractShapeRenderer {
	...
	protected Shape getRawShape(final VisualItem item) {
		...
		this.m_tmpPoints[0] = getAlignedPoint(item1.getBounds(), this.m_xAlign1, this.m_yAlign1);
		this.m_tmpPoints[1] = getAlignedPoint(item2.getBounds(), this.m_xAlign2, this.m_yAlign2);
