...
public abstract class AbstractShapeRenderer implements Renderer {
    ...
    private int m_renderType = AbstractShapeRenderer.RENDER_TYPE_DRAW_AND_FILL;
	...
	/**
     * Return the stroke to use for drawing lines and shape outlines. By default
     * returns the value of {@link VisualItem#getStroke()}. Subclasses can
     * override this method to implement custom stroke assignment, though
    ...
    public void setRenderType(final int type) {
        if ((type < AbstractShapeRenderer.RENDER_TYPE_NONE) || (type > AbstractShapeRenderer.RENDER_TYPE_DRAW_AND_FILL)) {
